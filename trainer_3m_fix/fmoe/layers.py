...
# from .functions import MOEScatter, MOEGather, MOELinear, MOEbiasLinear
    ...
    def forward(self, inp, fwd_expert_count, capacity=-1):
        ...
        # if self.bias is None:
            # x = MOELinear.apply(inp, self.weight, fwd_expert_count,
                                # capacity, self.training)
        # else:
            # x = MOEbiasLinear.apply(inp, self.weight, self.bias, fwd_expert_count,
                                    # capacity, self.training)
        return x
...
# def _fmoe_general_global_forward(inp, gate, expert_fn, num_expert, world_size,
    ...
    # )
    # x = expert_fn(x, fwd_expert_count, **kwargs)
    # x = MOEGather.apply(
