...
from model.conformer_fmoe_localComm_catEmbed_domain_acc_hier import Net as ConformerEncoder
...
class Net(nn.Module):
    ...
    def forward(self, data, lens, aed_target, aed_lens):
        out, out_lens, aux_embed, aux_loss, out_embed_6, out_embed_12, out_embed, out_mask = self.encoder(
        ...
        decoder_out_12, r_decoder_out_12, _ = self.decoder_2(out_embed_12, out_mask,
                                                     ys_in_pad, ys_in_lens,
                                                     r_ys_in_pad, self.reverse_weight)
        return out, out_lens, decoder_out, decoder_out_6, decoder_out_12, ys_out_pad, r_decoder_out, r_decoder_out_6, r_decoder_out_12, r_ys_out_pad, aux_embed, aux_loss
