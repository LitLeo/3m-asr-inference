#ifndef PLUGIN_SILU_PLUGIN_SILU_PLUGIN_H_
#define PLUGIN_SILU_PLUGIN_SILU_PLUGIN_H_
...
constexpr const char* SILU_PLUGIN_VERSION{"1"};
constexpr const char* SILU_PLUGIN_NAME{"SiluPluginDynamic"};

class SiluPlugin final : public nvinfer1::IPluginV2DynamicExt {
 ...
 public:
  SiluPlugin(const std::string name, const nvinfer1::DataType type);
  SiluPlugin(void const* serialData, size_t serialLength);
...
class SiluPluginCreator : public nvinfer1::IPluginCreator {
 public:
  SiluPluginCreator() {}
  ~SiluPluginCreator() {}
...
#endif  // PLUGIN_SILU_PLUGIN_SILU_PLUGIN_H_
